...
class ControllerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.return_value, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.return_value = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
...
module.exports = {
  ...
  md5sum() { return '770770ca4208a49b403ae37e8aa24498'; },
